        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-sm btn-default btn-warning" href="<?php echo base_url('member/binary');?>"><i class="fa fa-sitemap"></i>&nbsp;&nbsp;Downline Saya</a>
                </div>
                ...
                <div class="panel-footer">
                    <button type="submit" class="btn btn-sm btn-info col-md-offset-2"><i class="fa fa-save"></i> Simpan</button>
