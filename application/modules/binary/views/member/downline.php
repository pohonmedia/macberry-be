<div class="page-title">                    
    <h2><span class="fa fa-sitemap"></span> My Downline</h2>
</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">                                
                <div class="panel-heading">
                    <a class="btn btn-sm btn-info btn-flat" href="<?php echo base_url('member/binary/add'); ?>"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Tambah Downline</a>
                </div>
