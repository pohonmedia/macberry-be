<div class="page-title">                    
    <h2><span class="fa fa-edit"></span> Edit Selected Menu</h2>
</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url('admin/menus'); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;List Menu</a>
                </div>
