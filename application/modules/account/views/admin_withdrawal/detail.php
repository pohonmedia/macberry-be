<div class="page-title">                    
    <h2><span class="fa fa-money"></span> Withdrawal Detail</h2>
</div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-sm btn-default" href="<?php echo base_url('admin/account/withdrawal'); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;List Withdrawal</a>
                </div>
                <div class="panel-body">
                    <div class="box-body table-responsive">
                        <h3>Detail Topup ID <b class="text-danger">#<?php echo $detail->maw_trans_id . '</b> a.n ' . $detail->full_name; ?></h3>
                        <table>
                            <tr>
