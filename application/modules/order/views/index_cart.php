        ...
        <section id="checkoutpricing" class="c-checkout-pricing col-lg-4 col-12">
            <div class="card text-capitalize">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('order/payment'); ?>" class="c-btn-primary w-100 mt-4">lanjutkan pemesanan</a>
                    <a href="<?php echo base_url('catalogs'); ?>" class="c-btn-secondary w-100 mt-4">Lanjut Belanja</a>
                    <a href="<?php echo base_url('order/delete/all'); ?>" class="c-btn-secondary w-100 mt-4">Kosongkan Cart</a>
                </div>
            </div>
        </section>
