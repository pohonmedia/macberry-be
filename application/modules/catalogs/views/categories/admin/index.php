<!-- Toolbars -->
<h2 class="section-title">List All Product Categories</h2>
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <a class="btn btn-sm btn-info" href="<?php echo base_url('admin/catalogs'); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;Catalogs</a>
        <a class="btn btn-sm btn-info" href="<?php echo base_url('admin/catalogs/categories'); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;Categories&nbsp;&nbsp;&nbsp;<span class="badge badge-primary"><?php echo!empty($count_data) ? $count_data : 0; ?></span></a>
        <a class="btn btn-sm btn-info" href="<?php echo base_url('admin/catalogs/categories/add'); ?>"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;New Category</a>
    </div>
</div>
</br>
                ...
                <div>
                    <?php echo form_open(uri_string()); ?>
                        <div class="input-group">
                            <input type="text" name="catalog_categories_search" class="form-control" placeholder="Search by Name">
