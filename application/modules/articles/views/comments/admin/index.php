...
<section class="content-header">
    <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url('admin/articles/comments'); ?>"><i class="fa fa-list"></i>&nbsp;&nbsp;Comments&nbsp;&nbsp;&nbsp;<span class="label label-success"><?php echo!empty($count_data) ? $count_data : 0; ?></span></a>
    <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url('admin/articles/comments/add'); ?>"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;New Comment</a>
</section>
...
<section class="content">
    ...
    <div class="box box-danger">
        <div class="box-header with-border">
            <h3 class="box-title">List All Article Comments</h3>
        </div>
