...
class Admin extends Admin_Controller {
    ...
    public function __construct() {
        ...
        //Main Nav IDs
        $this->data['nav_active'] = 'payment';
        $this->data['subnav_active'] = 'payment';
        $this->breadcrumbs->push('Pembayaran', 'admin/payment');
    ...
    public function index() {
        ...
        if ($this->input->post('order_search') != "") {
            $param[] = array('field' => 'MO.vcordercode', 'param' => '', 'operator' => 'LIKE', 'value' => '%' . $this->input->post('products_search') . '%');
        ...
        $this->_paginate('admin/payment', $total_row, $limit);
        ...
        $this->data['page_desc'] = 'List All Payment';
