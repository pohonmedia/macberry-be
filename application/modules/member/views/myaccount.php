              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?php echo base_url('member/order');?>" class="nav-link"><i class="fa fa-list"></i> My Orders</a></li>
                    <li class="nav-item"><a href="<?php echo base_url('member/myaccount');?>"  class="nav-link active"><i class="fa fa-user"></i> My Account</a></li>
